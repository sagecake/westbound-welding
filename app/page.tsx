...
export default function Home() {
  ...
  return (
    <main style={{ background: "#0a0a0a", color: "#ffffff", fontFamily: "Arial, sans-serif" }}>
      ...
      <section
        style={{
          padding: isMobile ? "180px 16px 80px" : "180px 20px 140px",
          textAlign: "center",
          position: "relative",
        }}
      >
        ...
        <p style={{ position: "relative", fontSize: isMobile ? "16px" : "18px", lineHeight: 1.5 }}>
          Custom Fabrication • CNC Cutting • Mobile Welding
        </p>
        <p style={{ position: "relative", fontSize: isMobile ? "15px" : "16px", lineHeight: 1.5 }}>
      ...
      <section style={{ padding: isMobile ? "60px 16px" : "80px 20px" }}>
        ...
        <div style={grid}>
          ...
          <div className="hover-wrap" style={hoverWrap}><img src="/handrail3.jpg" alt="handrail3" style={imageStyle} /></div>
          <div className="hover-wrap" style={hoverWrap}><img src="/handrail4.jpg" alt="handrail4" style={imageStyle} /></div>
          <div className="hover-wrap" style={hoverWrap}><img src="/handrail5.jpg" alt="handrail5" style={imageStyle} /></div>
          <div className="hover-wrap" style={hoverWrap}><img src="/handrail6.jpg" alt="handrail6" style={imageStyle} /></div>
          <div className="hover-wrap" style={hoverWrap}><img src="/handrail7.jpg" alt="handrail7" style={imageStyle} /></div>
          <div className="hover-wrap" style={hoverWrap}><img src="/handrail8.jpg" alt="handrail8" style={imageStyle} /></div>
          <div className="hover-wrap" style={hoverWrap}><img src="/handrail9.jpg" alt="handrail9" style={imageStyle} /></div>
          <div className="hover-wrap" style={hoverWrap}><img src="/handrail10.jpg" alt="handrail10" style={imageStyle} /></div>
          <div className="hover-wrap" style={hoverWrap}><img src="/handrail11.jpg" alt="handrail11" style={imageStyle} /></div>
          <div className="hover-wrap" style={hoverWrap}><img src="/handrail12.jpg" alt="handrail12" style={imageStyle} /></div>
          <div className="hover-wrap" style={hoverWrap}><img src="/handrail13.jpg" alt="handrail13" style={imageStyle} /></div>
          <div className="hover-wrap" style={hoverWrap}><img src="/handrail14.jpg" alt="handrail14" style={imageStyle} /></div>
          <div className="hover-wrap" style={hoverWrap}><img src="/handrail15.jpg" alt="handrail15" style={imageStyle} /></div>
          <div className="hover-wrap" style={hoverWrap}><img src="/handrail16.jpg" alt="handrail16" style={imageStyle} /></div>
        </div>
      ...
      {/* CONTACT */}
      <section id="contact" style={{ padding: isMobile ? "60px 16px" : "80px 20px", textAlign: "center" }}>
